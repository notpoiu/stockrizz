    ...
    return (
        <main className="flex flex-col justify-center items-center w-screen h-screen">
            <div className="max-w-[500px]">
                ...
                <p className="mb-2">A: Stockrizz can make some mistakes, if you are a Developer and want to help reduce these errors you may find the full site source code <Link href="">here</Link></p>
            </div>
            <Link href={"/"}>
