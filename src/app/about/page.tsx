    ...
    return (
        <main className="flex flex-col justify-center items-center w-screen h-screen container">
            <div className="max-w-[500px]">
                ...
                <p className="mb-2">A: Stockrizz can make some mistakes, if you are a Developer or a Prompt Engineer, and want to help reduce these errors you may find the full site source code @ <Link href="https://github.com/notpoiu/stockrizz">Github</Link></p>
            </div>
            <Link href={"/"}>
